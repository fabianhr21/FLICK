...
def fetch_gba_buildings(bbox, target_crs, cache_dir, circle=None):
    ...
    if circle is not None:
        bldgs = bldgs[bldgs.geometry.centroid.within(circle)]
...
def main():
    ...
    buildings = fetch_gba_buildings(bounds, laz_crs, GBA_CACHE_DIR, circle)
    if buildings.empty:
