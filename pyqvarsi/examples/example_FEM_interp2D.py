#!/usr/bin/env python
#
# Example of the MESH class interpolation in 2D.
#
...
lnods = np.array([[1,2,4],[4,5,2],[2,3,5]],dtype=np.int32) - 1
ltype = np.array([10,10,10],dtype=np.int32)
...
p   = np.array([[0.,0.,0.],[0.1,0.1,0.],[1.3,0.575,0.]])
